...
import { Calendar, Clock, ArrowRight, CheckCircle2, AlertCircle, Sparkles, RotateCcw, Zap, Target, BookOpen, Play } from 'lucide-react';
                                            ...
                                            <div className="p-5 md:p-6">
                                                ...
                                                <div className={`mt-4 space-y-2.5 transition-all duration-500 ${isExpanded ? 'max-h-[600px] opacity-100' : 'max-h-24 overflow-hidden'}`}>
                                                    {dayPlan.tasks.map((task, tIndex) => (
                                                        <div
                                                            key={tIndex}
                                                            className={`flex items-start gap-3 p-3 rounded-xl transition-all duration-300 ${isExpanded ? `${color.bg} border ${color.border}` : ''} group/task`}
                                                        >
                                                            ...
                                                            <button
                                                                ...
                                                                className="mt-0.5 p-1.5 rounded-lg opacity-0 group-hover/task:opacity-100 bg-white/10 text-primary hover:bg-white/20 transition-all border border-white/10 flex-shrink-0"
                                                            >
                                                                <Play size={12} />
                                                            </button>
                                                        </div>
