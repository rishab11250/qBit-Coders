...
const Button = ({
    ...
    const variants = {
        primary: "bg-[var(--accent-primary)] text-[var(--text-on-accent)] hover:opacity-90 shadow-md hover:shadow-lg active:scale-95 hover:scale-105 transition-all duration-300",
        secondary: "bg-surface text-primary border border-primary/15 hover:bg-primary/5 active:scale-95 transition-all duration-200",
        danger: "bg-red-50 text-red-600 hover:bg-red-100 border border-red-200 active:scale-95 transition-all duration-200",
        ghost: "text-secondary hover:bg-primary/10 hover:text-primary active:scale-95 transition-all duration-200"
    };
